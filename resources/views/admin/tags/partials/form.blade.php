...
<div class="mb-4">
    ...
    <a href="{{ route('tags.index') }}" class="bg-gray-400 font-bold text-white px-4 py-2 transition duration-300 ease-in-out hover:bg-gray-600 rounded-full mx-2">Cancelar</a>
</div>
